    ...
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="/"><img src="{{ asset('frontend/assets/img/logo-dark.svg') }}" alt="cleaning"></a>
            </div>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>Name</label>
                                        <input type="text" class="form-control border-theme" name="name" placeholder="Name" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Phone</label>
                                        <input type="tel" class="form-control border-theme" name="phone" placeholder="Phone Number">
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control border-theme" name="password_confirmation" placeholder="Password" required>
                                </div>
                                <button type="submit" class="vs-btn2 w-100 p-2">Sign Up Now </button>
                            </form>
                            <p class="text-center mt-4">Already a member? <a href="/login" class="text-theme">Login Here</a></p>
                        </div>
                    </div>
                </div>
            </div>

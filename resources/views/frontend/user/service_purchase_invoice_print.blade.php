...
<head>
    ...
    {{-- Optional: use bootstrap if you want --}}
    ...
    <style>
        ...
        .muted { color:#6c757d; }
        .inv-box { border:1px solid #e9ecef; border-radius:12px; padding:18px; }
        .inv-table th, .inv-table td { padding: 10px 12px; }
        .inv-table tfoot th { background: #f8f9fa; }
        .no-print { margin: 12px 0 16px; }
    ...
    <div class="inv-box">
        ...
        <div class="row g-3 mb-3">
            <div class="col-6">
                ...
                <div><strong>Booking Date:</strong> {{ optional($booking->booking_date)->format('d M Y') }}</div>
